...
3. In the MobileFirst console, under **Applications** → **PreemptiveLoginCordova** → **Security** → **Map scope elements to security checks**, add a mapping from `accessRestricted` to `UserLogin`.
